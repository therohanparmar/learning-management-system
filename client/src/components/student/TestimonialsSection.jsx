...
const TestimonialsSection = () => {
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="grid grid-cols-3 gap-8 mt-14 md:px-40 ">
          ...
          >
            <div className="flex items-center gap-4 px-5 py-4 bg-gray-500/10">
              ...
              <div>
                ...
                <p className="text-gray800/80">{testimonial.role}</p>
              </div>
            </div>
            <div className="p-5 pb-7">
              <div className="flex gap-0.5">
                {[...Array(5)].map((_,i)=>(
                  <img className='h-5' src={i < Math.floor(testimonial.rating) ? assets.star : assets.star_blank} key={i} alt="Star" />
                ))}
              </div>
